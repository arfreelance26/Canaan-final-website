...
import { Truck, Package, FileCheck, Wrench } from "lucide-react";
...
const SERVICES = [
  ...
  },
  {
    Icon: Wrench,
    num: "04",
    image: "/company/service4.png",
    title: "Lashing & Fumigation",
    body: "Custom wooden lashing, palletisation, and crating to specification. Heat Treatment and fumigation certified to ISPM international phytosanitary norms.",
  },
];
        ...
        {SERVICES.map((svc, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Card image */}
              <div style={{ position: "relative", height: 280, borderRadius: 10, overflow: "hidden", flexShrink: 0, marginBottom: 5 }}>
                <img
                  src={svc.image}
                  alt={svc.title}
                  style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{
                  ...
                  <svc.Icon size={14} color={on ? "#c8b98a" : "#999"} />
                </div>
              </div>
